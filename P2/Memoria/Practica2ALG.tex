...
\\
	...
	\( T(n) = 1.39477\cdto10^{-6} k^2 - 0.000122489\cdot10^{-5}k + 0.0332803\).
...
\[
 	T(n) = 2^z T(1) + z\cdotc2\cdotk\cdotn
 \]
...
y podemos deducir entonces que si $M = max \left\lbrace n^2, \log_{2}(n) \cdot k \cdot n \right\rbrace $ nuestra función es
\[
 	T(n) \in \mathcal{O}(M)
 \]
